...
from scripts.update_news import make_item_id, normalize_url, parse_date_any, parse_opml_subscriptions
...
class UtilsTests(unittest.TestCase):
    ...
    @unittest.skip("AI-parent artifact: nuclear project has no Chinese-relative-time needs")
    def test_parse_relative_time_zh_minutes(self):
        from scripts.update_news import parse_relative_time_zh  # noqa: F401
